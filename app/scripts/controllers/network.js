'use strict';
angular.module('myBoardApp').controller('NetworkCtrl', function($scope, $rootScope, App, NetworkService) {
	/* ======================[ @TODO:
	...
	//Network Colors
	var instagramColor = '#F71A45', facebookColor = '#788AB3', twitterColor = '#3EBBF2';

	/* ======================[ @TODO: My Friends ]====================== */
	$scope.friendsChartData = [];
	$scope.buildFriendsChart = function() {
		$scope.friendsChartData.push({
			color : facebookColor,
			value : $scope.data.networks.facebook.followers,
			label : 'Facebook'
		});
		$scope.friendsChartData.push({
			color : instagramColor,
			value : $scope.data.networks.instagram.followers,
			label : 'Instagram'
		});
		$scope.friendsChartData.push({
			color : twitterColor,
			value : $scope.data.networks.twitter.followers,
			label : 'Twitter'
		});
	};
	/* ======================[ @TODO: My Trends ]====================== */
